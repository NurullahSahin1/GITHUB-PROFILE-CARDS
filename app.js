...
async function getUser(username) {
    try {
        ...
        // console.log(err);
        createErrorMessage("Böyle bir kullanıcı bulunmuyor")
...
function createErrorMessage(message) {
    const cardErrorHTML = `<div class="card"> <h2>${message}</h2> </div>`
...
async function getRepos(username) {
    try {
        ...
        createErrorMessage("üzgünüm repolar yüklenirken hata oluştu")
    }
}
